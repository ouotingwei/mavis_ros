...
ImuCamPose::ImuCamPose(KeyFrame *pKF):its(0)
{
    ...
    {
        // camera 3
        Eigen::Matrix4d Tlsl = pKF->GetRelativePoseTlsl().matrix().cast<double>();
        Rcw[2] = Tlsl.block<3,3>(0,0) * Rcw[0];
        tcw[2] = Tlsl.block<3,3>(0,0) * tcw[0] + Tlsl.block<3,1>(0,3);
        tcb[2] = Tlsl.block<3,3>(0,0) * tcb[0] + Tlsl.block<3,1>(0,3);
        Rcb[2] = Tlsl.block<3,3>(0,0) * Rcb[0];
        Rbc[2] = Rcb[2].transpose();
        tbc[2] = -Rbc[2] * tcb[2];
        pCamera[2] = pKF->mpCamera3;
        // camera 4
        Eigen::Matrix4d Trsl = pKF->GetRelativePoseTrsl().matrix().cast<double>();
        Rcw[3] = Trsl.block<3,3>(0,0) * Rcw[0];
        tcw[3] = Trsl.block<3,3>(0,0) * tcw[0] + Trsl.block<3,1>(0,3);
        tcb[3] = Trsl.block<3,3>(0,0) * tcb[0] + Trsl.block<3,1>(0,3);
        Rcb[3] = Trsl.block<3,3>(0,0) * Rcb[0];
...
ImuCamPose::ImuCamPose(Frame *pF):its(0)
{
    ...
    {
        // camera 3
        Eigen::Matrix4d Tlsl = pF->GetRelativePoseTlsl().matrix().cast<double>();
        Rcw[2] = Tlsl.block<3,3>(0,0) * Rcw[0];
        tcw[2] = Tlsl.block<3,3>(0,0) * tcw[0] + Tlsl.block<3,1>(0,3);
        tcb[2] = Tlsl.block<3,3>(0,0) * tcb[0] + Tlsl.block<3,1>(0,3);
        Rcb[2] = Tlsl.block<3,3>(0,0) * Rcb[0];
        ...
        // camera 4
        Eigen::Matrix4d Trsl = pF->GetRelativePoseTrsl().matrix().cast<double>();
        Rcw[3] = Trsl.block<3,3>(0,0) * Rcw[0];
        tcw[3] = Trsl.block<3,3>(0,0) * tcw[0] + Trsl.block<3,1>(0,3);
        tcb[3] = Trsl.block<3,3>(0,0) * tcb[0] + Trsl.block<3,1>(0,3);
        Rcb[3] = Trsl.block<3,3>(0,0) * Rcb[0];

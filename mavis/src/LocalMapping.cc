            ...
            const cv::KeyPoint &kp1 = (mpCurrentKeyFrame->NLeft == -1) ? mpCurrentKeyFrame->mvKeysUn[idx1]
                                                                        : (idx1 < mpCurrentKeyFrame->NLeft) ? mpCurrentKeyFrame->mvKeys[idx1]
                                                                            : (idx1 < mpCurrentKeyFrame->NLeft + mpCurrentKeyFrame->NRight) ? mpCurrentKeyFrame->mvKeysRight[idx1 - mpCurrentKeyFrame->NLeft]
                                                                                : (idx1 < mpCurrentKeyFrame->NLeft + mpCurrentKeyFrame->NRight + mpCurrentKeyFrame->NLeftSide) ? mpCurrentKeyFrame->mvKeysLeftSide[idx1 - mpCurrentKeyFrame->NLeft - mpCurrentKeyFrame->NRight]
                                                                                    : mpCurrentKeyFrame->mvKeysRightSide[idx1 - mpCurrentKeyFrame->NLeft - mpCurrentKeyFrame->NRight - mpCurrentKeyFrame->NLeftSide];
            ...
            int cameraId1 = (mpCurrentKeyFrame->NLeft == -1) ? 0
                                                             : (idx1 < mpCurrentKeyFrame->NLeft) ? 0
                                                                : (idx1 < mpCurrentKeyFrame->NLeft + mpCurrentKeyFrame->NRight) ? 1
                                                                    : (idx1 < mpCurrentKeyFrame->NLeft + mpCurrentKeyFrame->NRight + mpCurrentKeyFrame->NLeftSide) ? 2
                                                                        : 3;
            ...
            if(mpCurrentKeyFrame->mpCamera2 && pKF2->mpCamera2){
                ...
                if(mpCurrentKeyFrame->mpCamera3 && pKF2->mpCamera3 && mpCurrentKeyFrame->mpCamera4 && pKF2->mpCamera4)
                {
                    if(cameraId1 == 0 && cameraId2 == 2)
                    {
                        ...
                        sophTcw2 = pKF2->GetLeftSidePose();
                        Ow2 = pKF2->GetLeftSideCameraCenter();
                    ...
                    {
                        sophTcw1 = mpCurrentKeyFrame->GetLeftSidePose();
                        Ow1 = mpCurrentKeyFrame->GetLeftSideCameraCenter();
                    ...
                    else if(cameraId1 == 1 && cameraId2 == 3)
                    {
                        ...
                        sophTcw2 = pKF2->GetRightSidePose();
                        Ow2 = pKF2->GetRightSideCameraCenter();
                    ...
                    {
                        sophTcw1 = mpCurrentKeyFrame->GetRightSidePose();
                        Ow1 = mpCurrentKeyFrame->GetRightSideCameraCenter();
...
void LocalMapping::SearchInNeighbors()
{
    ...
    for(vector<KeyFrame*>::iterator vit=vpTargetKFs.begin(), vend=vpTargetKFs.end(); vit!=vend; vit++)
    {
        ...
        if(pKFi->NLeftSide != -1 || pKFi->NRightSide != -1)
        {
    ...
    if(mpCurrentKeyFrame->NLeftSide != -1 || mpCurrentKeyFrame->NRightSide != -1)
    {
                ...
                if(!pMP->isBad())
                {
                    ...
                    if(pMP->Observations()>thObs)
                    {
                        const int &scaleLevel = (pKF->NLeft == -1) ? pKF->mvKeysUn[i].octave
                                                ...
                                                : (i < pKF->NLeft + pKF->NRight + pKF->NLeftSide) ? pKF->mvKeysLeftSide[i - pKF->NLeft - pKF->NRight].octave
                                                : pKF->mvKeysRightSide[i - pKF->NLeft - pKF->NRight - pKF->NLeftSide].octave;
                        ...
                        for(map<KeyFrame*, tuple<int,int,int,int>>::const_iterator mit=observations.begin(), mend=observations.end(); mit!=mend; mit++)
                        {
                            ...
                            int leftsideIndex = get<2>(indexes), rightsideIndex = get<3>(indexes);
                            int scaleLeveli = -1;
                            if(pKFi -> NLeft == -1)
                                ...
                                if (leftsideIndex != -1) {
                                    int leftsideLevel = pKFi->mvKeysLeftSide[leftsideIndex - pKFi->NLeft - pKFi->NRight].octave;
                                    scaleLeveli = (scaleLeveli == -1 || scaleLeveli > leftsideLevel) ? leftsideLevel
                                    : scaleLeveli;
                                }

                                if (rightsideIndex != -1) {
                                    int rightsideLevel = pKFi->mvKeysRightSide[rightsideIndex - pKFi->NLeft - pKFi->NRight - pKFi->NLeftSide].octave;
                                    scaleLeveli = (scaleLeveli == -1 || scaleLeveli > rightsideLevel) ? rightsideLevel
                                    : scaleLeveli;
                                }
                            }

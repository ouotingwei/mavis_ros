...
namespace ORB_SLAM3 {
    ...
    public:
        ...
        Sophus::SE3f Tls() {return Tls_;}
        Sophus::SE3f Trs() {return Trs_;}
        Sophus::SE3f Tlls() {return Tlls_;}
        Sophus::SE3f Tlrs() {return Tlrs_;}
    ...
    private:
        ...
        void readCamera1(cv::FileStorage& fSettings);   // stereo_left or rgb-d or mono
        void readCamera2(cv::FileStorage& fSettings);   // stereo right
        void readCamera3(cv::FileStorage& fSettings);   // MCSLAM+DE
        void readCamera4(cv::FileStorage& fSettings);   // MCSLAM+DE
         ...
         * Visual stuff
         */
        GeometricCamera* calibration1_, *calibration2_, *calibration3_, *calibration4_;   //Camera calibration
        ...
        Sophus::SE3f Tlr_, Tls_, Trs_;
        Sophus::SE3f Tlls_, Tlrs_;
        float thDepth_;
        float bf_, b_;  

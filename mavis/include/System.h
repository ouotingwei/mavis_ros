...
public:
    ...
    // mavis-RGB-D Mode
    Sophus::SE3f TrackMC(const cv::Mat &imLeft, const cv::Mat &imRight, const cv::Mat &imLeftSide, const cv::Mat&imRightSide, const double &timestamp, const vector<IMU::Point>& vImuMeas, string filename="");

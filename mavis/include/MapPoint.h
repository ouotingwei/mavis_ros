...
class MapPoint
{
    ...
    void serialize(Archive & ar, const unsigned int version)
    {
        ...
        ar & mnTrackScaleLevelLS;
        ar & mnTrackScaleLevelRS;
        ar & mTrackViewCos;
        ar & mTrackViewCosR;
        ar & mTrackViewCosLS;
        ar & mTrackViewCosRS;
...
public:
    ...
    float mTrackProjXRS;
    float mTrackProjYRS;
    bool mbTrackInView, mbTrackInViewR, mbTrackInViewLS, mbTrackInViewRS;
    int mnTrackScaleLevel, mnTrackScaleLevelR, mnTrackScaleLevelLS, mnTrackScaleLevelRS;
    float mTrackViewCos, mTrackViewCosR, mTrackViewCosLS, mTrackViewCosRS;

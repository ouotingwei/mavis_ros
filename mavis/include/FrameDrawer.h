...
public:
    ...
    cv::Mat DrawLeftSideFrame(float imageScale=1.f);
    cv::Mat DrawRightSideFrame(float imageScale=1.f);
...
protected:
    ...
    cv::Mat mIm, mImRight, mImLeftSide, mImRightSide;
    int N;
    vector<cv::KeyPoint> mvCurrentKeys,mvCurrentKeysRight, mvCurrentKeysLeftSide, mvCurrentKeysRightSide;

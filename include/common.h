...
#include <mavis_ros/SaveMap.h> // This file is created automatically, see here http://wiki.ros.org/ROS/Tutorials/CreatingMsgAndSrv#Creating_a_srv
...
// bool save_map_srv(mvvio_ros::SaveMap::Request&, mvvio_ros::SaveMap::Response&);
// bool save_traj_srv(mvvio_ros::SaveMap::Request&, mvvio_ros::SaveMap::Response&);
